...
{
  document.getElementById('img-flower').setAttribute('src', 'https://github.com/acnhdev/acnhcrosstest/blob/master/assets/img/' + sel.options[sel.selectedIndex].text + '-red.png');
}
